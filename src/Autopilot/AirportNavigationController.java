...
public class AirportNavigationController extends AutopilotFlightController {
    ...
    /**
     * Checks if the controller has reached the destination airport landing point
     * if the final turn is finished the controller has also finished doing its job
     ...
     * @return true if the final turn generated by the path generator is finished
     */
    @Override
    ...
    /**
     * Checks if the delta angle generated by the current and previous inputs will
     * cause the angle to get a different sign compared to the turn angle
     * --> used in the check if the airport navigation controller has reached objective
     * @param currentInputs the inputs most recently received from the testbed
     * @param previousInputs the inputs previously received from the testbed
...
//            errorLog(errorInput);
         ...
         */
        private float calcDeltaAngle(AutopilotInputs_v2 currentInputs, AutopilotInputs_v2 previousInputs, AutopilotTurn turn) {
